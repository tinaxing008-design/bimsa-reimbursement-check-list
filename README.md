    ...
    <div class="section-body">
      ...
      <div id="domesticTravel" class="tab-pane active-pane">
        ...
        <ul class="doc-list">
          ...
          <li>Stamped hotel folio showing price breakdown, dates, guest info</li>
        ...
        <ul class="doc-list">
          ...
          <li><strong>Prerequisite:</strong> Invitation must explicitly state "no meals or local transport provided".</li>
        </ul>
