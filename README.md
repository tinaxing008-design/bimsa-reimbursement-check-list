...
<head>
  ...
  <title>BIMSA Reimbursement | Travel & Labor Service Fee – Complete Guide</title>
  <!-- Google Fonts -->
  ...
  <style>
    * {
    ...
    .section-card {
      ...
      box-shadow: 0 8px 20px rgba(0, 0, 0, 0.02), 0 0 0 1px #e2edf2;
      overflow: hidden;
...
<div class="reimbursement-container">
  ...
  <div class="section-card" id="travel-section-card">
    ...
    <div class="section-body">
      ...
      <div id="domesticTravel" class="tab-pane active-pane">
        ...
        <div class="doc-list">
          <li>Leave Application form (<span style="color:crimson;">THE grant used for reimbursement must match leave application</span>)</li>
        ...
        <h3 style="font-weight: 600; margin-top: 1rem;">✈️ Flight:</h3>
        <ul class="doc-list">
          <li>Boarding passes (photo or original)</li>
          <li>Chinese VAT invoice (remark need show itinerary, passenger info)</li>
          <li>Online order page or booking confirmation email (showing price breakdown, passenger & itinerary)</li>
          <li>Payment proof (if >10k RMB)</li>
        </ul>
        <h3 style="font-weight: 600;">🚆 Train:</h3>
        <ul class="doc-list">
          <li>Online order page or booking confirmation email (if online booking)</li>
          <li>Train ticket invoice (only can be issued via official China Railway app 12306 or from the train station counter) – <a href="https://www.12306.cn/en/index.html" target="_blank">12306 website</a> | <a href="https://beyond-shenzhen.cn/en/blog/railway-electronic-invoice/" target="_blank">Guide on invoice</a></li>
        </ul>
        <h3 style="font-weight: 600;">🏨 Hotel:</h3>
        <ul class="doc-list">
          <li>Chinese VAT invoice</li>
          <li>Stamped hotel folio showing price breakdown, dates, guest info; or the check-in voucher attached at the confirmation email from Trip.com</li>
          <li>Online order or booking confirmation email if booked online</li>
        </ul>
        ...
        <ul class="doc-list">
          ...
          <li><strong>Prerequisite:</strong> Invitation should explicitly state "no meals or local transport provided".</li>
        </ul>
      ...
      <div id="internationalTravel" class="tab-pane">
        ...
        <ul class="doc-list">
          ...
          <li>Exchange rate calculation: please refer to <a href="https://www.pbc.gov.cn/zhengcehuobisi/125207/125217/125925/index.html?eqid=cbd09930007ad0ac000000066451f874" target="_blank">PBOC Exchange Rate</a>; for less-used currencies, please refer to <a href="https://www.chinamoney.com.cn/chinese/bkcrr/" target="_blank">China Money Exchange Rate</a></li>
        </ul>
        ...
        <h3 style="font-weight: 600;">🏨 Hotel:</h3>
        <ul class="doc-list">
          <li>Electronic hotel invoice/receipt; if booked via Chinese websites (incl. Trip.com), Chinese VAT invoice needed</li>
          <li>Stamped hotel folio showing price breakdown, dates, guest info； or the check-in voucher attached at the confirmation email from Trip.com</li>
          <li>Online order or booking confirmation email if booked online</li>
        </ul>
        <h3 style="font-weight: 600;">🚗 Car ride to/from airport:</h3>
        ...
        <ul class="doc-list">
          <li>For BIMSA people: per diem based on leave application days.</li>
          <li>For visitors: BIMSA does not provide per diem.</li>
          <li>International per diem varies by destination → refer to p.44-45 <a href="https://bimsa.net/doc/regulations/%E5%8C%97%E4%BA%AC%E9%9B%81%E6%A0%96%E6%B9%96%E5%BA%94%E7%94%A8%E6%95%B0%E5%AD%A6%E7%A0%94%E7%A9%B6%E9%99%A2%E5%9B%A0%E5%85%AC%E4%B8%B4%E6%97%B6%E5%87%BA%E5%9B%BD%E8%B4%B9%E7%94%A8%E7%AE%A1%E7%90%86%E5%8A%9E%E6%B3%95%EF%BC%88%E8%AF%95%E8%A1%8C%EF%BC%89.pdf"><i>北京雁栖湖应用数学研究院因公临时出国费用管理办法（试行）</i></a></li>
        </ul>
        <h4>📅 Per diem counting rules</h4>
        <table class="perdiem-table">
          <thead><tr><th>Trip duration (days)</th><th>Allowance calculation</th></tr></thead>
          <tbody>
            <tr><td>≤ 10 days</td><td>Full allowance for all days (meal + local transport).</td></tr>
            <tr><td>10–15 days</td><td>10 days full + extra days at half rate.</td></tr>
            <tr><td>≥ 15 days</td><td>10 days full + 5 days half (remaining days no per diem).</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div id="tripcomGuide" class="tab-pane">
        ...
        <ul class="doc-list">
          <li><strong>Step 1</strong> → Go to <strong>My bookings</strong></li>
          <li><strong>Step 2</strong> → Choose your hotel or flight booking</li>
          <li><strong>Step 3</strong> → Go to <strong>Service Chat</strong> and select <strong>Chinese VAT invoice</strong></li>
          <li><strong>Step 4</strong> → Provide the tax number and Chinese name of BIMSA in chatbox:</li>
        </ul>
        <div style="background:#eef3f9; padding: 1rem; border-radius: 14px; margin: 1rem 0;">
  ...
  <div class="section-card">
    ...
    <div class="section-body">
      <div class="inline-tabs" id="laborTabs">
        <button class="tab-btn active-tab" data-tab="honorariaTab">🏆 Honoraria for talks</button>
        <button class="tab-btn" data-tab="stipendTab">🎓 Stipend for visitors</button>
      ...
      <div id="honorariaTab" class="tab-pane active-pane">
        <ul class="doc-list">
          <li><strong>Standard rates:</strong><br/>
            - 2000 RMB per engagement for guests <strong>from outside Beijing</strong><br/>
...
<script>
  ...
  function initSectionTabs(sectionContainerId, tabButtonsSelector, tabPanesMapping) {
    ...
    const panes = {};
    for (const [key, paneId] of Object.entries(tabPanesMapping)) {
      const paneElem = document.getElementById(paneId);
      if (paneElem) panes[key] = paneElem;
    }
  ...
  initSectionTabs('laborTabs', '.tab-btn', {
    'honorariaTab': 'honorariaTab',
    'stipendTab': 'stipendTab',
    'notesTab': 'notesTab'
  });
